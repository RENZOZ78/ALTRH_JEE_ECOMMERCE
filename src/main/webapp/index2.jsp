	...
	$().ready(function() {
		...
		$("#signupForm").validate({
			...
			messages: {				
				...
				adresse: "Please accept our policy"
			}
		});
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="post" action="Client" id="signupForm">  
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" name="btn" value="Inscription">Inscription</button>
      </div>
    </form>
</div>
...
<div class="modal fade" id="ModalConnexion" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Connexion à un compte</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form method="post" action="Client">  
          ...
          <div class="form-group">
            <label for="recipient-emailConnexion" class="col-form-label">Email:</label>
            <input type="email" class="form-control" id="recipient-emailConnexion" name="email">
          </div>
          <div class="form-group">
            <label for="recipient-mdpConnexion" class="col-form-label">Mot de passe:</label>
            <input type="password" class="form-control" id="recipient-mdpConnexion" name="pwd">
          </div>
          
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="submit" class="btn btn-primary" name="btn" value="Connexion">Connexion</button>
      </div>
    </form>
    </div>
  </div>
	...
	<div class="top-bar">
		<div class="container">
			...
			<div class="tb-shopping-cart pull-right">
				...
				<a href="#" class="btn btn-white btn-xs" data-toggle="modal" data-target="#ModalInscription">Créer un compte</a>
				<a href="#" class="btn btn-white btn-xs" data-toggle="modal" data-target="#ModalConnexion">Se connecter</a>
				</div>
